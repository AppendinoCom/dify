const translation = {
  ...
  joinTipEnd: ' team on TechCloud.sk',
  invalid: 'The link has expired',
  explore: 'Explore TechCloud.sk',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on TechCloud.sk and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The TechCloud.sk Enterprise license for your workspace has expired. Please contact your administrator to continue using TechCloud.sk.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect TechCloud.sk license server. Please contact your administrator to continue using TechCloud.sk.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The TechCloud.sk Enterprise license for your workspace is inactive. Please contact your administrator to continue using TechCloud.sk.',
}
